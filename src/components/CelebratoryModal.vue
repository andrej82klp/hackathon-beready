          ...
          <div class="mt-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              <button
                ...
                class="flex-1 bg-blue-400 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-500 transition-colors duration-200 flex items-center justify-center"
              >
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
