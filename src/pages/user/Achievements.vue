          ...
          <div class="p-6">
            ...
            <div class="mt-4 flex gap-2">
              <button
                ...
                class="flex-1 bg-yellow-400 text-teal-800 px-3 py-2 rounded-lg text-sm font-semibold hover:bg-yellow-300 transition-colors duration-200"
              >
                Share
              </button>
        ...
        <div class="bg-yellow-50 rounded-xl border-2 border-yellow-200 p-8">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              class="bg-blue-400 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-500 transition-colors duration-200 flex items-center justify-center"
            >
              <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
...
const shareBadge = (badge: any) => {
  shareAchievement('facebook', badge.name)
}
